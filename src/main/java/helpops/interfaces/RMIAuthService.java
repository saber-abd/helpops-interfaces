...
public interface RMIAuthService extends Remote {  //interface RMI pour authentification
    ...
    boolean verifierToken(String tokenValeur) throws RemoteException; // retourne true ou false selon la validite
    ...
    String getRoleDepuisToken(String tokenValeur) throws RemoteException; // V2 : Validation pour le serveur d'incident, ermet de vérifier à la fois si le token est bon ET quel est son rôle
}
